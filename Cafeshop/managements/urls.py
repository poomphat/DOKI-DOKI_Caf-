...
urlpatterns = [
    ...
    path('list_drink/<str:status>/', views.list_drink, name='list_drink'),
    path('list_fruit/<str:status>/', views.list_fruit, name='list_fruit'),
    path('list_option/<str:status>/', views.list_option, name='list_option'),
